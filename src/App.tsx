...
export default function App() {
  ...
  <div className="min-h-screen bg-slate-900 text-slate-100">
    ...
    <nav className="bg-slate-800 border-b border-slate-700 px-6 py-4 flex justify-between items-center">
      ...
      <div className="flex items-center space-x-4">
        ...
        <button 
          ...
          className="text-sm bg-slate-750 text-red-400 px-3 py-1.5 rounded-lg border border-red-500/30 cursor-pointer"
        >
          Salir
        </button>
      </div>
    ...
    {/* 2. MENÚ SELECTOR DE PESTAÑAS (TABS) - ¡Asegúrate de tener esto! */}
    ...
    <main className="max-w-4xl mx-auto p-4 sm:p-6 mt-2">
      {tabActiva === 'partidos' ? (
        ...
        <Leaderboard /> // El componente de la tabla de posiciones que creamos
      )}
    </main>
  </div>
);
